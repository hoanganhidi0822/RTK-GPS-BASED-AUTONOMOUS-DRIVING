...
class PerceptionCore:
    ...
    def __init__(
        ...
        if camera_matrix_path is None:
            camera_matrix_path = base_dir / "camera_param" / "camera_matrix.txt"
        if dist_coeffs_path is None:
            dist_coeffs_path = base_dir / "camera_param" / "distortion_coefficients.txt"
        ...
        if depth_ckpt is None:
            depth_ckpt = base_dir / "checkpoints" / f"depth_anything_v2_{encoder}.pth"
